									...
									<table class="table table-bordered">
										...
										<tbody>
											<c:forEach var="item" items= "${model.listResult }">
												<tr>
													<td><input type="checkbox" id="checkbox_${item.idgiong}" value="${item.idgiong}"></td>
													<td>${item.tengiong}</td>
													<td>${item.idloai}</td>
													<td>
														<c:url var="editURL" value="/admin-new">
															<c:param name="type" value="edit"/>
															<c:param name="id" value="${item.idgiong}"/>
														</c:url>
